-- Tournament Platform Database Schema
...
-- This function runs with SECURITY DEFINER to have access to auth.users
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    -- This prevents the auth signup from failing if profile creation has issues
...
CREATE OR REPLACE VIEW public.tournaments_with_organizer AS
SELECT 
  t.*,
